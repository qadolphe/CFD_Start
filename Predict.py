...
# Load the saved model (adjust path if necessary)
model = load_model('velocity_density_predictorCyl.h5')  # For SavedModel format
# or
# model = load_model('/content/my_model.h5')  # For HDF5 format
...
# Create animation
anim = FuncAnimation(fig, update, frames=range(Nt), interval=1, blit=True)
